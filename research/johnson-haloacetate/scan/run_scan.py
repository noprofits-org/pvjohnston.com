            ...
            writer.writerow(
                {
                    ...
                    "q_o_mbis": fmt(record.get("q_o_mbis"), 6),
                    "q_coo_mbis": fmt(record.get("q_coo_mbis"), 6),
                    "q_o_lowdin": fmt(record.get("q_o_lowdin"), 6),
                    "q_coo_lowdin": fmt(record.get("q_coo_lowdin"), 6),
