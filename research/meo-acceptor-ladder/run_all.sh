#!/usr/bin/env bash
# Canonical run for the acceptor-strength ladder.
#
# Three rungs, fixed para-methoxy donor, increasing acceptor strength:
#   meo-cn   meo-dcv   meo-tcf
#
# Stages run in SERIES on purpose: def2-TZVP TD-DFT on ~17-35 atoms is several
...
STATES="${STATES:-12}"
MOLECULES="${MOLECULES:-meo-cn meo-dcv meo-tcf}"
FORCE="${FORCE:-0}"
...
echo "  images/2026-08-16-how-the-acceptor-closes-the-gap-figure.png  hero PNG"
